...
=== Grafana dashboard fails to display migration memory transfer rate
...
image::monitoring/before-patch-memory-transfer-rate-metric.png[Migration Memory Transfer Rate dashboard panel (no data)]
...
image::monitoring/after-patch-memory-transfer-rate-metric.png[Migration Memory Transfer Rate dashboard panel (with data)]

Related issue: https://github.com/harvester/harvester/issues/11390[#11390]